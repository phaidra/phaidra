...
**** Technical sketch
   ...
   #+begin_src dot :file "./pictures/construction_demo.svg" :exports results
     graph G {
             rankdir="LR"
...
**** Technical sketch
   ...
   #+begin_src dot :file "./pictures/construction_ssl.svg" :exports results
     graph G {
             rankdir="LR"
...
**** Technical sketch
   ...
   #+begin_src dot :file "./pictures/construction_shib.svg" :exports results
     graph G {
             rankdir="LR"
