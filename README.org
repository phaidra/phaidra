  ...
  #+begin_src dot :file "./images/construction.svg" :exports results
    graph G {
            ...
            subgraph cluster_host {
                    ADMIN [label="Developer/Admin", shape = doubleoctagon, color = magenta];
                    ...
                    subgraph cluster_host_storage {
                            ...
                            HS2 [label="./mariadb_init/phaidradb.sql.gz"];
                            HS3 [label="${FEDORA_DATA}/data/ocfl-root"];
                            HS4 [label="./mariadb_init/phaidradb.sql.gz"];
                            ...
                            HS14 [label="./container_configs/nginx"];
                    ...
                    subgraph cluster_docker_network_host {
                            ...
                            subgraph cluster_docker_network_volumes {
                                    ...
                                    DPV14 [label="/etc/nginx/templates"];
            ...
            DPV14 -- DPS12 [color="green"];
            HS14 -- DPV14 [color="blue"];
            ...
            DPS2 -- DPS1,DPS3,DPS4,DPS5,DPS6,DPS7,DPS8,DPS12 [color="orange"];
            DPS4 -- DPS9 [color="orange"];
            DPS5 -- DPS12 [color="orange"];
            DPS6 -- DPS11 [color="orange"];
            DPS10 -- DPS3,DPS4,DPS13,DPS12 [color="orange"];            
            DPS11 -- DPS12 [color="orange"];


            // outside communication mapping

            USER -- DPS12 [color="red"];
    }
  #+end_src
