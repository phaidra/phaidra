...
COPY ./../component_configs/phaidra-api/phaidra.yml /etc/
WORKDIR /usr/local/phaidra/
ARG CACHEBUST=1
RUN git clone https://github.com/phaidra/phaidra-api.git
COPY ./../component_configs/phaidra-api/PhaidraAPI.json /usr/local/phaidra/phaidra-api/
RUN unlink /usr/local/phaidra/phaidra-api/log4perl.conf
COPY ./../component_configs/phaidra-api/log4perl.conf /usr/local/phaidra/phaidra-api/
