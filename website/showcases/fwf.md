# FWF Showcase { .phaidra-section-heading }

*Ensuring Meaningful Open Access for Publicly Funded Research.*
...
## A Dual Responsibility { .phaidra-showcase-heading }
...
## Extending Open Access to Monographs { .phaidra-showcase-heading }
...
## The Problem: Publisher Purgatory { .phaidra-showcase-heading }
...
## Taking Control: The FWF's Solution { .phaidra-showcase-heading }
...
## PHAIDRA: Open Source Enabling Integration { .phaidra-showcase-heading }
...
## Beyond PDF: Supporting the Real Needs of Scholarship { .phaidra-showcase-heading }
...
## Key Benefits Delivered by PHAIDRA { .phaidra-showcase-heading }
