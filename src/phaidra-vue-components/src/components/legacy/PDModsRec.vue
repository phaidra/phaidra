  ...
  <v-col>
    <v-row v-for="(ch, i) in orderedChildren" :key="ch.xmlname+i">
      ...
      <template v-else-if="ch.xmlname === 'name'">
        <v-col cols="12" md="2" class="pdlabel text-secondary font-weight-bold text-md-right">{{ getNameRole(ch) }}</v-col>
        <v-col cols="12" md="10" class="wiv">{{ getNameName(ch) }}</v-col>
      </template>
      <template v-else-if="ch.xmlname === 'originInfo'">
        <v-col cols="12" md="2" class="pdlabel text-secondary font-weight-bold text-md-right">{{ $t('PUBLISHER_VERLAG') }}</v-col>
      ...
      <template v-else-if="ch.input_type === 'input_text'">
        <template v-if="ch.xmlname === 'languageTerm'">
          <v-col cols="12" md="2" class="pdlabel text-secondary font-weight-bold text-md-right">{{ $t(getLabel(ch)) }}</v-col>
