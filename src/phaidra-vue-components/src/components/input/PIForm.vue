                  ...
                  <v-row no-gutters>
                    <v-col>
                      <v-dialog v-if="addbutton && (s.addbutton != false)" class="pb-4" v-model="s['adddialogue']" scrollable width="700px">
                        ...
                        <v-card>
                          <v-card-title class="title font-weight-light text-white"><span v-t="'Add metadata fields'"></span><v-spacer></v-spacer><v-btn color="white" class="grey--text text--darken-2" target='_blank' :to="'/metadata-fields-help'" prepend-icon="mdi-help-circle-outline">{{ $t('Metadata fields Help') }}</v-btn></v-card-title>
                          <v-card-text>
                            <v-list lines="two" >
