...
const vocabularies = {
  ...
  'relations': {
    terms: [
      ...
      { '@id': 'info:fedora/fedora-system:def/relations-external#hasCollectionMember', 'skos:prefLabel': { 'eng': 'Has part', 'deu': 'hat Collection Mitglieder', 'ita': 'Ha membri della Collezione' }, 'skos:notation': ['hasCollectionMember'] },
      { '@id': 'http://pcdm.org/models#hasMember', 'skos:prefLabel': { 'eng': 'Has member', 'deu': 'hat Mitglieder', 'ita': 'Ha membri del Contenitore' }, 'skos:notation': ['hasMember'] },
  ...
  'rolepredicate': {
    terms: [
      ...
      { '@id': 'role:clr', 'skos:prefLabel': { 'eng': 'Colorist', 'deu': 'Kolorist*in', 'ita': 'Colorista' }, 'skos:definition': { 'eng': 'A person or organization responsible for applying color to drawings, prints, photographs, maps, moving images, etc.', 'deu': 'Eine Person oder Organisation, die für das Aufbringen von Farbe auf Zeichnungen, Drucke, Fotos, Karten, bewegte Bilder usw. verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile dell\'applicazione del colore a disegni, stampe, fotografie, mappe, immagini in movimento, ecc.' } },
      { '@id': 'role:cmm', 'skos:prefLabel': { 'eng': 'Commentator', 'deu': 'Kommentator*in', 'ita': 'Commentatore di audiovisivi' }, 'skos:definition': { 'eng': 'A performer contributing to a work by providing interpretation, analysis, or a discussion of the subject matter on a recording, film, or other audiovisual medium.', 'deu': 'Ein*e ausübende*r Künstler*in, der bzw. die einen Beitrag zu einem Werk leistet, indem er bzw. sie eine Interpretation, Analyse oder Diskussion des Themas auf einer Aufnahme, einem Film oder einem anderen audiovisuellen Medium liefert.', 'ita': 'Un interprete che contribuisce a un\'opera fornendo interpretazione, analisi o una discussione dell\'argomento su una registrazione, film o altro mezzo audiovisivo.' } },
      ...
      { '@id': 'role:crr', 'skos:prefLabel': { 'eng': 'Corrector', 'deu': 'Korrektor*in', 'ita': 'Correttore' }, 'skos:definition': { 'eng': 'A person or organization who is a corrector of manuscripts, such as the scriptorium official who corrected the work of a scribe. For printed matter, use Proofreader.', 'deu': 'Eine Person oder Organisation, die Manuskripte korrigiert, z. B. ein Skriptoriumsbeamter bzw. eine Skriptoriumsbeamtin, der bzw. die die Arbeit eines Schreibers bzw. einer Schreiberin korrigiert. Für Drucksachen verwenden Sie Korrekturleser*in.', 'ita': 'Una persona o organizzazione che corregge manoscritti, come l\'ufficiale dello scriptorium che correggeva il lavoro di uno scriba. Per il materiale stampato, utilizzare Correttore di bozze.' } },
      ...
      { '@id': 'role:led', 'skos:prefLabel': { 'eng': 'Lead', 'deu': 'Leitung', 'ita': 'Capo' }, 'skos:definition': { 'eng': 'A person or organization that takes primary responsibility for a particular activity or endeavor. May be combined with another relator term or code to show the greater importance this person or organization has regarding that particular role. If more than one relator is assigned to a heading, use the Lead relator only if it applies to all the relators.', 'deu': 'Eine Person oder Organisation, die die Hauptverantwortung für eine bestimmte Aktivität oder ein bestimmtes Unterfangen trägt. Kann mit einem anderen Beauftragtenbegriff oder -code kombiniert werden, um die größere Bedeutung dieser Person oder Organisation in Bezug auf diese spezielle Rolle zu verdeutlichen. Wenn einer Rubrik mehr als ein Verantwortlicher bzw. eine Verantwortliche zugeordnet ist, verwenden Sie den Begriff "Hauptverantwortliche*r" nur, wenn er auf alle Verantwortlichen zutrifft.', 'ita': 'Una persona o organizzazione che assume la responsabilità primaria per una particolare attività o iniziativa. Può essere combinato con un altro termine o codice di relazione per mostrare la maggiore importanza che questa persona o organizzazione ha riguardo a quel particolare ruolo. Se a un\'intestazione sono assegnati più relatori, utilizzare il relatore Capo solo se si applica a tutti i relatori.' } },
      { '@id': 'role:len', 'skos:prefLabel': { 'eng': 'Lender', 'deu': 'Leihgeber', 'ita': 'Prestatore' }, 'skos:definition': { 'eng': 'A person or organization permitting the temporary use of a book, manuscript, etc., such as for photocopying or microfilming.', 'deu': 'Eine Person oder Organisation, die die vorübergehende Nutzung eines Buches, Manuskripts usw. gestattet, z. B. zum Fotokopieren oder Mikroverfilmen.', 'ita': 'Una persona o organizzazione che consente l\'uso temporaneo di un libro, manoscritto, ecc., ad es. per fotocopiatura o microfilmatura.' } },
      { '@id': 'role:lbt', 'skos:prefLabel': { 'eng': 'Librettist', 'deu': 'Librettist*in', 'ita': 'Librettista' }, 'skos:definition': { 'eng': 'An author of a libretto of an opera or other stage work, or an oratorio.', 'deu': 'Ein*e Autor*in eines Librettos einer Oper oder eines anderen Bühnenwerks oder eines Oratoriums.', 'ita': 'Un autore di un libretto di un\'opera o altro lavoro teatrale, o un oratorio.' } },
      { '@id': 'role:lse', 'skos:prefLabel': { 'eng': 'Licensee', 'deu': 'Lizenznehmer*in', 'ita': 'Licenziatario' }, 'skos:definition': { 'eng': 'A person or organization who is an original recipient of the right to print or publish.', 'deu': 'Eine Person oder Organisation, die das ursprüngliche Druck- oder Veröffentlichungsrecht erhalten hat.', 'ita': 'Una persona o organizzazione che è il destinatario originario del diritto di stampare o pubblicare.' } },
      { '@id': 'role:lso', 'skos:prefLabel': { 'eng': 'Licensor', 'deu': 'Lizenzgeber*in', 'ita': 'Licenziatore' }, 'skos:definition': { 'eng': 'A person or organization who is a signer of the license, imprimatur, etc.', 'deu': 'Eine Person oder Organisation, die eine Lizenz, ein Imprimatur usw. unterzeichnet.', 'ita': 'Una persona o organizzazione che è firmataria della licenza, imprimatur, ecc.' } },
      ...
      { '@id': 'role:pht', 'skos:prefLabel': { 'eng': 'Photographer', 'deu': 'Fotograf*in', 'ita': 'Fotografo' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating a photographic work.', 'deu': 'Eine Person, Familie oder Organisation, die für die Erstellung eines fotografischen Werks verantwortlich ist.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione di un\'opera fotografica.' } },
      { '@id': 'role:plt', 'skos:prefLabel': { 'eng': 'Platemaker', 'deu': 'Druckplattenhersteller*in allgemein', 'ita': 'Produttore delle lastre' }, 'skos:definition': { 'eng': 'A person, family, or organization involved in manufacturing a manifestation by preparing plates used in the production of printed images and/or text.', 'deu': 'Eine Person, Familie oder Organisation, die an der Herstellung einer Manifestation beteiligt ist, indem sie Druckplatten für die Produzione di gedruckten Bildern und/oder Texten vorbereitet.', 'ita': 'Una persona, famiglia o organizzazione coinvolta nella produzione di una manifestazione preparando lastre utilizzate nella produzione di immagini e/o testo stampati.' } },
      ...
      { '@id': 'role:rth', 'skos:prefLabel': { 'eng': 'Research team head', 'deu': 'Leiter*in eines Forschungsteams', 'ita': 'Direttore della ricerca' }, 'skos:definition': { 'eng': 'A person who directed or managed a research project.', 'deu': 'Eine Person, die ein Forschungsprojekt leitet oder verwaltet.', 'ita': 'Una persona che ha diretto o gestito un progetto di ricerca.' } },
      ...
      { '@id': 'role:tcd', 'skos:prefLabel': { 'eng': 'Technical director', 'deu': 'Technische/r Direktor*in', 'ita': 'Direttore tecnico' }, 'skos:definition': { 'eng': 'A person who is ultimately in charge of scenery, props, lights and sound for a production.', 'deu': 'Eine Person, die letztendlich für Bühnenbild, Requisiten, Licht und Ton bei einer Produktion verantwortlich ist.', 'ita': 'Una persona che è in definitiva responsabile di scenografia, oggetti di scena, luci e suono per una produzione.' } },
      { '@id': 'role:technicalinspector', 'skos:prefLabel': { 'eng': 'Technical Inspector', 'deu': 'Technische/r Prüfer*in', 'ita': 'Collaudatore' }, 'skos:definition': { 'eng': 'A person or organisation who has checked the metadata of an object after it has been uploaded to the repository.', 'deu': 'Eine Person oder Organisation, die die Metadaten eines Objekts nach dessen Upload ins Repositorium überprüft hat.', 'ita': 'Una persona o organizzazione che ha controllato i metadati di un oggetto dopo che è stato caricato nel repository.' } },
      { '@id': 'role:technicaltranslator', 'skos:prefLabel': { 'eng': 'Technical Translator', 'deu': 'Technische/r Übersetzer*in', 'ita': 'Traduttore Tecnico' }, 'skos:definition': { 'eng': 'A person or organisation who is responsible for archiving and publishing a digital object in the repository.', 'deu': 'Eine Person oder Organisation, die für die Archivierung und Veröffentlichung eines digitalen Objekts im Repositorium zuständig ist.', 'ita': 'Una persona o organizzazione responsabile dell\'archiviazione e pubblicazione di un oggetto digitale nel repository.' } },
      { '@id': 'role:tld', 'skos:prefLabel': { 'eng': 'Television director', 'deu': 'Fernsehintendant*in', 'ita': 'Regista televisivo' }, 'skos:definition': { 'eng': 'A director responsible for the general management and supervision of a television program.', 'deu': 'Eine Regisseur*in, der bzw. die für die allgemeine Verwaltung und Überwachung eines Fernsehprogramms verantwortlich ist.', 'ita': 'Un regista responsabile della gestione generale e della supervisione di un programma televisivo.' } },
      { '@id': 'role:tlp', 'skos:prefLabel': { 'eng': 'Television producer', 'deu': 'Fernsehproduzent*in', 'ita': 'Produttore televisivo' }, 'skos:definition': { 'eng': 'A producer responsible for most of the business aspects of a television program.', 'deu': 'Eine Produzent*in, der bzw. die für die meisten geschäftlichen Aspekte eines Fernsehprogramms verantwortlich ist.', 'ita': 'Un produttore responsabile della maggior parte degli aspetti commerciali di un programma televisivo.' } },
      { '@id': 'role:textprocessor', 'skos:prefLabel': { 'eng': 'Text Processor', 'deu': 'Textbearbeiter*in', 'ita': 'Estensore del testo' }, 'skos:definition': { 'eng': 'A person or organisation responsible for processing text in a document.', 'deu': 'Eine Person oder Organisation, die für die Bearbeitung von Text in einem Dokument verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile dell\'elaborazione del testo in un documento.' } },
      { '@id': 'role:ths', 'skos:prefLabel': { 'eng': 'Thesis advisor', 'deu': 'Dissertationsbetreuer*in', 'ita': 'Relatore di tesi' }, 'skos:definition': { 'eng': 'A person under whose supervision a degree candidate develops and presents a thesis, mémoire, or text of a dissertation.', 'deu': 'Eine Person, unter deren Aufsicht ein*e Kandidat*in eine Dissertation, ein Mémoire oder einen Dissertationstext erarbeitet und vorlegt.', 'ita': 'Una persona sotto la cui supervisione un candidato a un titolo accademico sviluppa e presenta una tesi, mémoire o testo di una dissertazione.' } },
      { '@id': 'role:trc', 'skos:prefLabel': { 'eng': 'Transcriber', 'deu': 'Transkriptor*in von Noten', 'ita': 'Trascrittore' }, 'skos:definition': { 'eng': 'A person, family, or organization contributing to a resource by changing it from one system of notation to another. For a work transcribed for a different instrument or performing group, see Arranger [arr]. For makers of pen-facsimiles, use Facsimilist [fac].', 'deu': 'Eine Person, Familie oder Organisation, die zu einer Ressource beiträgt, indem sie sie von einem Notationssystem in ein anderes umwandelt. Für ein Werk, das für ein anderes Instrument oder eine andere Ausführungsgruppe transkribiert wurde, siehe Arrangeur*in. Für Hersteller*innen von Stift-Faksimiles verwenden Sie Ersteller*in des Faksimile.', 'ita': 'Una persona, famiglia o organizzazione che contribuisce a una risorsa cambiandola da un sistema di notazione a un altro. Per un\'opera trascritta per un diverso strumento o gruppo esecutivo, vedere Arrangiatore [arr]. Per i produttori di facsimili a penna, utilizzare Facsimilista [fac].' } },
      { '@id': 'role:trl', 'skos:prefLabel': { 'eng': 'Translator', 'deu': 'Übersetzer*in', 'ita': 'Traduttore' }, 'skos:definition': { 'eng': 'A person or organization who renders a text from one language into another, or from an older form of a language into the modern form.', 'deu': 'Eine Person oder Organisation, die einen Text von einer Sprache in eine andere oder von einer älteren Form einer Sprache in die moderne Form überträgt.', 'ita': 'Una persona o organizzazione che traduce un testo da una lingua a un\'altra, o da una forma più antica di una lingua alla forma moderna.' } },
      { '@id': 'role:tyd', 'skos:prefLabel': { 'eng': 'Type designer', 'deu': 'Schriftdesigner*in / Schriftentwerfer*in', 'ita': 'Disegnatore dei caratteri' }, 'skos:definition': { 'eng': 'A person or organization who designs the type face used in a particular item.', 'deu': 'Eine Person oder Organisation, die das für einen bestimmten Artikel verwendete Schriftbild entwirft.', 'ita': 'Una persona o organizzazione che progetta il carattere tipografico utilizzato in un particolare documento.' } },
      { '@id': 'role:tyg', 'skos:prefLabel': { 'eng': 'Typographer', 'deu': 'Typograph*in', 'ita': 'Tipografo' }, 'skos:definition': { 'eng': 'A person or organization primarily responsible for choice and arrangement of type used in an item. If the typographer is also responsible for other aspects of the graphic design of a book (e.g., Book designer [bkd]), codes for both functions may be needed.', 'deu': 'Eine Person oder Organisation, die in erster Linie für die Auswahl und Anordnung der in einem Artikel verwendeten Schrift verantwortlich ist. Wenn der bzw. die Typograf*in auch für andere Aspekte der grafischen Gestaltung eines Buches verantwortlich ist (z. B. Buchgestalter*in), können Codes für beide Funktionen erforderlich sein.', 'ita': 'Una persona o organizzazione principalmente responsabile della scelta e disposizione del carattere utilizzato in un documento. Se il tipografo è anche responsabile di altri aspetti del design grafico di un libro (ad es., Designer del libro [bkd]), potrebbero essere necessari codici per entrambe le funzioni.' } },
      { '@id': 'role:uploader', 'skos:prefLabel': { 'eng': 'Uploader', 'deu': 'Uploader', 'ita': 'Responsabile del caricamento' }, 'skos:definition': { 'eng': 'A person or organisation responsible for uploading a digital object into the repository.', 'deu': 'Eine Person oder Organisation, die für das Hochladen eines digitalen Objekts in das Repositorium verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile del caricamento di un oggetto digitale nel repository.' } },
  ...
  'submitrolepredicate': {
    terms: [
      ...
      { '@id': 'role:adp', 'skos:prefLabel': { 'eng': 'Adapter', 'deu': 'Bearbeiter*in', 'ita': 'Adattatore' }, 'skos:definition': { 'eng': 'A person or organization who 1) reworks a musical composition, usually for a different medium, or 2) rewrites novels or stories for motion pictures or other audiovisual medium.', 'deu': 'Eine Person oder Organisation, die 1) eine Musikkomposition überarbeitet, in der Regel für ein anderes Medium, oder 2) Romane oder Geschichten für Filme oder andere audiovisuelle Medien umschreibt.', 'ita': 'Una persona o organizzazione che 1) rielabora una composizione musicale, di solito per un mezzo diverso, o 2) riscrive romanzi o storie per film o altri media audiovisivi.' } },
      { '@id': 'role:arc', 'skos:prefLabel': { 'eng': 'Architect', 'deu': 'Architekt*in', 'ita': 'Architetto' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating an architectural design, including a pictorial representation intended to show how a building, etc., will look when completed. It also oversees the construction of structures.', 'deu': 'Eine Person, eine Familie oder eine Organisation, die für die Erstellung eines architektonischen Entwurfs verantwortlich ist, einschließlich einer bildlichen Darstellung, die zeigen soll, wie ein Gebäude usw. nach seiner Fertigstellung aussehen wird. Sie beaufsichtigt auch den Bau von Bauwerken.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione di un progetto architettonico, compresa una rappresentazione pittorica finalizzata a mostrare come un edificio, ecc., apparirà una volta completato. Sovrintende anche alla costruzione delle strutture.' } },
      { '@id': 'role:art', 'skos:prefLabel': { 'eng': 'Artist', 'deu': 'Künstler*in', 'ita': 'Artista' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating a work by conceiving, and implementing, an original graphic design, drawing, painting, etc. For book illustrators, prefer Illustrator [ill].', 'deu': 'Eine Person, Familie oder Organisation, die für die Schaffung eines Werks verantwortlich ist, indem sie ein originelles grafisches Design, eine Zeichnung, un Gemälde usw. entwirft und umsetzt. Für Buchillustrator*innen ist Illustrator*in [ill] vorzuziehen.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione di un\'opera concependo e realizzando un disegno grafico originale, un dipinto, ecc. Per gli illustratori di libri, preferire Illustratore [ill].' } },
      { '@id': 'role:att', 'skos:prefLabel': { 'eng': 'Attributed name', 'deu': 'Zugeschriebene/r Autor*in', 'ita': 'Nome attribuito' }, 'skos:definition': { 'eng': 'An author, artist, etc., relating him/her to a resource for which there is or once was substantial authority for designating that person as author, creator, etc. of the work.', 'deu': 'Ein*e Autor*in, Künstler*in usw., der bzw. die mit einer Quelle in Verbindung gebracht wird, für die es eine wesentliche Berechtigung gibt oder gab, diese Person als Autor*in, Schöpfer*in usw. des Werks zu bezeichnen.', 'ita': 'Un autore, artista, ecc., collegandolo a una risorsa per la quale esisteva o esiste un\'autorità sostanziale per designare quella persona come autore, creatore, ecc. dell\'opera.' } },
      { '@id': 'role:aut', 'skos:prefLabel': { 'eng': 'Author', 'deu': 'Autor*in', 'ita': 'Autore' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating a work that is primarily textual in content, regardless of media type (e.g., printed text, spoken word, electronic text, tactile text) or genre (e.g., poems, novels, screenplays, blogs). Use also for persons, etc., creating a new work by paraphrasing, rewriting, or adapting works by another creator such that the modification has substantially changed the nature and content of the original or changed the medium of expression.', 'deu': 'Eine Person, Familie oder Organisation, die für die Schaffung eines Werks verantwortlich ist, das hauptsächlich textlichen Inhalt hat, unabhängig von der Art des Mediums (z. B. gedruckter Text, gesprochener Text, elektronischer Text, taktiler Text) oder dem Genre (z. B. Gedichte, Romane, Drehbücher, Blogs). Verwenden Sie den Begriff auch für Personen usw., die ein neues Werk schaffen, indem sie Werke eines anderen Schöpfers bzw. einer anderen Schöpferin paraphrasieren, umschreiben oder adaptieren, so dass die Modifikation die Art und den Inhalt des Originals wesentlich verändert oder das Ausdrucksmedium verändert hat.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione di un\'opera a contenuto principalmente testuale, indipendentemente dal tipo di supporto (ad es., testo stampato, parola parlata, testo elettronico, testo tattile) o genere (ad es., poesie, romanzi, sceneggiature, blog). Utilizzare anche per persone, ecc., che creano una nuova opera parafrasando, riscrivendo o adattando opere di un altro creatore in modo tale che la modifica abbia sostanzialmente cambiato la natura e il contenuto dell\'originale o abbia cambiato il mezzo di espressione.' } },
      { '@id': 'role:chr', 'skos:prefLabel': { 'eng': 'Choreographer', 'deu': 'Choreograph*in', 'ita': 'Coreografo' }, 'skos:definition': { 'eng': 'A person responsible for creating or contributing to a work of movement.', 'deu': 'Eine Person, die für die Schaffung eines Werks der Bewegung verantwortlich ist oder zu diesem beiträgt.', 'ita': 'Una persona responsabile della creazione o del contributo a un\'opera di movimento.' } },
      { '@id': 'role:col', 'skos:prefLabel': { 'eng': 'Collector', 'deu': 'Sammler*in', 'ita': 'Collezionista' }, 'skos:definition': { 'eng': 'A curator who brings together items from various sources that are then arranged, described, and cataloged as a collection. A collector is neither the creator of the material nor a person to whom manuscripts in the collection may have been addressed.', 'deu': 'Ein*e Kurator*in, der bzw. die Objekte aus verschiedenen Quellen zusammenführt, che dann als Sammlung geordnet, beschrieben und katalogisiert werden. Ein*e Sammler*in ist weder der bzw. die Schöpfer*in des Materials noch eine Person, an die die Manuskripte in der Sammlung möglicherweise adressiert waren.', 'ita': 'Un curatore che riunisce elementi da varie fonti che sono poi organizzati, descritti e catalogati come una collezione. Un collezionista non è né il creatore del materiale né una persona a cui i manoscritti della collezione potrebbero essere stati indirizzati.' } },
      { '@id': 'role:cmp', 'skos:prefLabel': { 'eng': 'Composer', 'deu': 'Komponist*in', 'ita': 'Compositore' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating or contributing to a musical resource by adding music to a work that originally lacked it or supplements it.', 'deu': 'Eine Person, Familie oder Organisation, die dafür verantwortlich ist, eine musikalische Ressource zu schaffen oder zu ihr beizutragen, indem sie Musik zu einem Werk hinzufügt, in dem sie ursprünglich fehlte oder die es ergänzt.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione o del contributo a una risorsa musicale aggiungendo musica a un\'opera che originariamente ne era priva o la integra.' } },
      { '@id': 'role:cnd', 'skos:prefLabel': { 'eng': 'Conductor', 'deu': 'Dirigent*in', 'ita': 'Direttore d\'orchestra' }, 'skos:definition': { 'eng': 'A performer contributing to a musical resource by leading a performing group (orchestra, chorus, opera, etc.) in a musical or dramatic presentation, etc.', 'deu': 'Ein*e Künstler*in, der bzw. die zu einer musikalischen Ressource beiträgt, indem er bzw. sie eine ausführende Gruppe (Orchester, Chor, Oper usw.) bei einer musikalischen oder dramatischen Darbietung usw. leitet.', 'ita': 'Un interprete che contribuisce a una risorsa musicale guidando un gruppo di esecutori (orchestra, coro, opera, ecc.) in una rappresentazione musicale o drammatica, ecc.' } },
      { '@id': 'role:con', 'skos:prefLabel': { 'eng': 'Conservator', 'deu': 'Konservator*in', 'ita': 'Conservatore' }, 'skos:definition': { 'eng': 'A person or organization responsible for documenting, preserving, or treating printed or manuscript material, works of art, artifacts, or other media.', 'deu': 'Eine Person oder Organisation, die für die Dokumentazione, Bewahrung oder Bearbeitung von gedrucktem oder handschriftlichem Material, Kunstwerken, Artefakten oder anderen Medien verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile della documentazione, conservazione o trattamento di materiale stampato o manoscritto, opere d\'arte, manufatti o altri media.' } },
      { '@id': 'role:dnc', 'skos:prefLabel': { 'eng': 'Dancer', 'deu': 'Tänzer*in', 'ita': 'Ballerino' }, 'skos:definition': { 'eng': 'A performer who dances in a musical, dramatic, etc., presentation.', 'deu': 'Ein*e Darsteller*in, der bzw. die in einer musikalischen, dramatischen usw. Präsentation tanzt.', 'ita': 'Un interprete che danza in una presentazione musicale, drammatica, ecc.' } },
      { '@id': 'role:dtc', 'skos:prefLabel': { 'eng': 'Data contributor', 'deu': 'Datenlieferant*in', 'ita': 'Fornitore di dati' }, 'skos:definition': { 'eng': 'A person or organization that submits data for inclusion in a database or other collection of data.', 'deu': 'Eine Person oder Organisation, die Daten zur Aufnahme in una Datenbank oder una andere Datensammlung einreicht.', 'ita': 'Una persona o organizzazione che invia dati per l\'inclusione in un database o altra raccolta di dati.' } },
      { '@id': 'role:dgg', 'skos:prefLabel': { 'eng': 'Degree granting institution', 'deu': 'Verleihende Institution des akademischen Abschlusses', 'ita': 'Conferitore di titolo accademico' }, 'skos:definition': { 'eng': 'A organization granting an academic degree.', 'deu': 'Eine Organisation, die einen akademischen Grad verleiht.', 'ita': 'Un\'organizzazione che conferisce un titolo accademico.' } },
      { '@id': 'role:dgs', 'skos:prefLabel': { 'eng': 'Degree supervisor', 'deu': 'Betreuer*in der Hochschulschrift', 'ita': 'Supervisore di titolo accademico' }, 'skos:definition': { 'eng': 'A person overseeing a higher level academic degree.', 'deu': 'Eine Person, die für einen höheren akademischen Grad verantwortlich ist.', 'ita': 'Una persona che supervisiona un titolo accademico di livello superiore.' } },
      { '@id': 'role:dsr', 'skos:prefLabel': { 'eng': 'Designer', 'deu': 'Designer*in', 'ita': 'Disegnatore' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating a design for an object.', 'deu': 'Eine Person, Familie oder Organisation, die für den Entwurf eines Objekts verantwortlich ist.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione di un disegno per un oggetto.' } },
      { '@id': 'role:digitiser', 'skos:prefLabel': { 'eng': 'Digitiser', 'deu': 'Digitalisierer*in', 'ita': 'Autore della digitalizzazione' }, 'skos:definition': { 'eng': 'A person or organisation responsible for converting physical materials into digital format.', 'deu': 'Eine Person oder Organisation, die für die Umwandlung von physischem Material in ein digitales Format verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile della conversione di materiali fisici in formato digitale.' } },
      { '@id': 'role:dis', 'skos:prefLabel': { 'eng': 'Dissertant', 'deu': 'Verfasser*in der Hochschulschrift', 'ita': 'Autore della dissertazione' }, 'skos:definition': { 'eng': 'A person who presents a thesis for a university or higher-level educational degree.', 'deu': 'Eine Person, die una Abschlussarbeit für eine Universität oder einen höheren Bildungsabschluss vorlegt.', 'ita': 'Una persona che presenta una tesi per un titolo universitario o di istruzione superiore.' } },
      ...
      { '@id': 'role:fmd', 'skos:prefLabel': { 'eng': 'Film director', 'deu': 'Filmregisseur*in', 'ita': 'Regista del film' }, 'skos:definition': { 'eng': 'A director responsible for the general management and supervision of a filmed performance.', 'deu': 'Ein*e Regisseur*in, der bzw. die für die allgemeine Verwaltung und Überwachung einer Filmvorführung verantwortlich ist.', 'ita': 'Un regista responsabile della gestione generale e della supervisione di una performance filmata.' } },
      { '@id': 'role:fon', 'skos:prefLabel': { 'eng': 'Founder', 'deu': 'Gründer*in', 'ita': 'Fondatore' }, 'skos:definition': { 'eng': 'A person or organisation who played a significant role in initiating, establishing, or creating a particular entity, project, or endeavor.', 'deu': 'Eine Person oder Organisation, che eine bedeutende Rolle bei der Initiierung, Gründung oder Schaffung einer bestimmten Entität, eines Projekts oder einer Unternehmung gespielt hat.', 'ita': 'Una persona o organizzazione che ha svolto un ruolo significativo nell\'iniziare, stabilire o creare una particolare entità, progetto o iniziativa.' } },
      { '@id': 'role:fnd', 'skos:prefLabel': { 'eng': 'Funder', 'deu': 'Geldgeber*in', 'ita': 'Finanziatore' }, 'skos:definition': { 'eng': 'A person or organization that furnished financial support for the production of the work.', 'deu': 'Eine Person oder Organisation, die die Produktion des Werks finanziell unterstützt hat.', 'ita': 'Una persona o organizzazione che ha fornito supporto finanziario per la produzione dell\'opera.' } },
      { '@id': 'role:graphicdesigner', 'skos:prefLabel': { 'eng': 'Graphic Designer', 'deu': 'Grafikdesigner*in', 'ita': 'Grafico' }, 'skos:definition': { 'eng': 'A person or organisation responsible for creating visual concepts, graphics, and layouts.', 'deu': 'Eine Person oder Organisation, die für das Erstellen visueller Konzepte, Grafiken und Layouts zuständig ist.', 'ita': 'Una persona o organizzazione responsabile della creazione di concetti visivi, grafica e layout.' } },
      { '@id': 'role:interpreter', 'skos:prefLabel': { 'eng': 'Interpreter', 'deu': 'Dolmetscher*in', 'ita': 'Interprete (lingua)' }, 'skos:definition': { 'eng': 'A person who translates spoken or signed language from one language to another (in real-time settings or for recorded or delayed communication).', 'deu': 'Eine Person, die gesprochene oder gebärdete Sprache von einer Sprache in eine andere übersetzt (in Echtzeit oder für aufgezeichnete oder verzögerte Kommunikation).', 'ita': 'Una persona che traduce la lingua parlata o segnata da una lingua a un\'altra (in ambienti in tempo reale o per comunicazioni registrate o ritardate).' } },
      { '@id': 'role:ive', 'skos:prefLabel': { 'eng': 'Interviewee', 'deu': 'Interviewpartner*in', 'ita': 'Intervistato' }, 'skos:definition': { 'eng': 'A person, family or organization responsible for creating or contributing to a resource by responding to an interviewer, usually a reporter, pollster, or some other information gathering agent.', 'deu': 'Eine Person, Familie oder Organisation, die dafür verantwortlich ist, una Ressource zu erstellen oder zu ihr beizutragen, indem sie einem Interviewer bzw. einer Interviewerin, in der Regel einem Reporter bzw. einer Reporterin, einem Meinungsforscher bzw. einer Meinungsforscherin oder einem anderen Informationsbeschaffer bzw. einer anderen Informationsbeschafferin, antwortet.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione o del contributo a una risorsa rispondendo a un intervistatore, di solito un giornalista, sondaggista o qualche altro agente di raccolta informazioni.' } },
      { '@id': 'role:ivr', 'skos:prefLabel': { 'eng': 'Interviewer', 'deu': 'Interviewer*in', 'ita': 'Intervistatore' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating or contributing to a resource by acting as an interviewer, reporter, pollster, or some other information gathering agent.', 'deu': 'Eine Person, Familie oder Organisation, die für die Erstellung oder den Beitrag zu una risorsa verantwortlich ist, indem sie als Interviewer*in, Reporter*in, Meinungsforscher*in o sonstige*r Informationsbeschaffer*in fungiert.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione o del contributo a una risorsa agendo come intervistatore, giornalista, sondaggista o qualche altro agente di raccolta informazioni.' } },
      { '@id': 'role:keeperoftheoriginal', 'skos:prefLabel': { 'eng': 'Keeper of the original', 'deu': 'Aufbewahrer*in des Originals', 'ita': 'Affidatario dell\'originale' }, 'skos:definition': { 'eng': 'A person or organisation who is entrusted with the custody of the original physical material from which a digital copy has been made.', 'deu': 'Eine Person oder Organisation, die mit der Aufbewahrung des physischen Originalmaterials betraut ist, von dem una digitale Kopien erstellt wurde.', 'ita': 'Una persona o organizzazione a cui è affidata la custodia del materiale fisico originale da cui è stata realizzata una copia digitale.' } },
      { '@id': 'role:led', 'skos:prefLabel': { 'eng': 'Lead', 'deu': 'Leitung', 'ita': 'Capo' }, 'skos:definition': { 'eng': 'A person or organization that takes primary responsibility for a particular activity or endeavor. May be combined with another relator term or code to show the greater importance this person or organization has regarding that particular role. If more than one relator is assigned to a heading, use the Lead relator only if it applies to all the relators.', 'deu': 'Eine Person oder Organisation, die die Hauptverantwortung für eine bestimmte Aktivität oder ein bestimmtes Unterfangen trägt. Kann mit einem anderen Beauftragtenbegriff oder -code kombiniert werden, um die größere Bedeutung dieser Person oder Organisation in Bezug auf diese spezielle Rolle zu verdeutlichen. Wenn einer Rubrik mehr als ein Verantwortlicher bzw. eine Verantwortliche zugeordnet ist, verwenden Sie den Begriff "Hauptverantwortliche*r" nur, wenn er auf alle Verantwortlichen zutrifft.', 'ita': 'Una persona o organizzazione che assume la responsabilità primaria per una particolare attività o iniziativa. Può essere combinato con un altro termine o codice di relazione per mostrare la maggiore importanza che questa persona o organizzazione ha riguardo a quel particolare ruolo. Se a un\'intestazione sono assegnati più relatori, utilizzare il relatore Capo solo se si applica a tutti i relatori.' } },
      { '@id': 'role:mfr', 'skos:prefLabel': { 'eng': 'Manufacturer', 'deu': 'Hersteller*in', 'ita': 'Manifattore' }, 'skos:definition': { 'eng': 'A person or organization responsible for printing, duplicating, casting, etc. a resource.', 'deu': 'Eine Person oder Organisation, die für das Drucken, Vervielfältigen, Gießen usw. einer Ressource verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile della stampa, duplicazione, fusione, ecc. di una risorsa.' } },
      { '@id': 'role:mte', 'skos:prefLabel': { 'eng': 'Metal-engraver', 'deu': 'Metallstecher*in', 'ita': 'Incisore su metallo' }, 'skos:definition': { 'eng': 'An engraver responsible for decorations, illustrations, letters, etc. cut on a metal surface for printing or decoration.', 'deu': 'Ein Graveur, der für Verzierungen, Illustrationen, Buchstaben usw. verantwortlich ist, die zu Druck- oder Dekorationszwecken in eine Metalloberfläche geschnitten werden.', 'ita': 'Un incisore responsabile di decorazioni, illustrazioni, lettere, ecc. tagliate su una superficie metallica per la stampa o la decorazione.' } },
      { '@id': 'role:nrt', 'skos:prefLabel': { 'eng': 'Narrator', 'deu': 'Erzähler*in', 'ita': 'Narratore' }, 'skos:definition': { 'eng': 'A performer contributing to a resource by reading or speaking in order to give an account of an act, occurrence, course of events, etc.', 'deu': 'Ein Darsteller, der zu einer Ressource beiträgt, indem er etwas vorliest oder spricht, um einen Bericht über eine Handlung, ein Ereignis, einen Ablauf usw. zu geben.', 'ita': 'Un interprete che contribuisce a una risorsa leggendo o parlando per fornire un resoconto di un atto, evento, corso di eventi, ecc.' } },
      { '@id': 'role:pedagogicexpert', 'skos:prefLabel': { 'eng': 'Pedagogic Expert', 'deu': 'Pädagogische/r Expert*in', 'ita': 'Pedagogista' }, 'skos:definition': { 'eng': 'A person or organisation who contributes specialized knowledge and expertise in pedagogy to scientific work.', 'deu': 'Eine Person oder Organisation, die Fachwissen und pädagogische Kompetenz in die wissenschaftliche Arbeit einbringt.', 'ita': 'Una persona o organizzazione che contribuisce con conoscenze specializzate e competenza in pedagogia al lavoro scientifico.' } },
      { '@id': 'role:pht', 'skos:prefLabel': { 'eng': 'Photographer', 'deu': 'Fotograf*in', 'ita': 'Fotografo' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for creating a photographic work.', 'deu': 'Eine Person, Familie oder Organisation, die für die Erstellung eines fotografischen Werks verantwortlich è.', 'ita': 'Una persona, famiglia o organizzazione responsabile della creazione di un\'opera fotografica.' } },
      { '@id': 'role:pro', 'skos:prefLabel': { 'eng': 'Producer', 'deu': 'Produzent*in', 'ita': 'Produttore' }, 'skos:definition': { 'eng': 'A person, family, or organization responsible for most of the business aspects of a production for screen, audio recording, television, webcast, etc. The producer is generally responsible for fund raising, managing the production, hiring key personnel, arranging for distributors, etc.', 'deu': 'Eine Person, Familie oder Organisation, die für die meisten geschäftlichen Aspekte einer Produktion für Leinwand, Tonaufnahme, Fernsehen, Webcast usw. verantwortlich ist. Der Produzent bzw. die Produzentin ist in der Regel für die Mittelbeschaffung, das Management della Produktion, die Einstellung von Schlüsselpersonal, die Vermittlung von Verleiher*innen usw. verantwortlich.', 'ita': 'Una persona, famiglia o organizzazione responsabile della maggior parte degli aspetti commerciali di una produzione per schermo, registrazione audio, televisione, webcast, ecc. Il produttore è generalmente responsabile della raccolta fondi, gestione della produzione, assunzione di personale chiave, organizzazione dei distributori, ecc.' } },
      { '@id': 'role:res', 'skos:prefLabel': { 'eng': 'Researcher', 'deu': 'Forscher*in', 'ita': 'Ricercatore' }, 'skos:definition': { 'eng': 'A person or organization responsible for performing research.', 'deu': 'Eine Person oder Organisation, die für die Durchführung von Forschungsarbeiten verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile di condurre ricerca.' } },
      { '@id': 'role:spk', 'skos:prefLabel': { 'eng': 'Speaker / Lecturer', 'deu': 'Sprecher*in / Vortragende/r', 'ita': 'Oratore' }, 'skos:definition': { 'eng': 'A performer contributing to a resource by speaking words, such as a lecture, speech, etc.', 'deu': 'Ein*e Darsteller*in, der bzw. die zu una risorsa beiträgt, indem er bzw. die Worte spricht, z. B. bei einem Vortrag, einer Rede usw.', 'ita': 'Un interprete che contribuisce a una risorsa pronunciando parole, come una lezione, discorso, ecc.' } },
      { '@id': 'role:ths', 'skos:prefLabel': { 'eng': 'Thesis advisor', 'deu': 'Dissertationsbetreuer*in', 'ita': 'Relatore di tesi' }, 'skos:definition': { 'eng': 'A person under whose supervision a degree candidate develops and presents a thesis, mémoire, or text of a dissertation.', 'deu': 'Eine Person, unter deren Aufsicht ein*e Kandidat*in eine Dissertation, ein Mémoire oder einen Dissertationstext erarbeitet und vorlegt.', 'ita': 'Una persona sotto la cui supervisione un candidato a un titolo accademico sviluppa e presenta una tesi, mémoire o testo di una dissertazione.' } },
      { '@id': 'role:trl', 'skos:prefLabel': { 'eng': 'Translator', 'deu': 'Übersetzer*in', 'ita': 'Traduttore' }, 'skos:definition': { 'eng': 'A person or organization who renders a text from one language into another, or from an older form of a language into the modern form.', 'deu': 'Eine Person oder Organisation, die einen Text von einer Sprache in eine andere oder von einer älteren Form einer Sprache in die moderne Form überträgt.', 'ita': 'Una persona o organizzazione che traduce un testo da una lingua a un\'altra, o da una forma più antica di una lingua alla forma moderna.' } },
      { '@id': 'role:uploader', 'skos:prefLabel': { 'eng': 'Uploader', 'deu': 'Uploader', 'ita': 'Responsabile del caricamento' }, 'skos:definition': { 'eng': 'A person or organisation responsible for uploading a digital object into the repository.', 'deu': 'Eine Person oder Organisation, che für das Hochladen eines digitalen Objekts in das Repositorium verantwortlich ist.', 'ita': 'Una persona o organizzazione responsabile del caricamento di un oggetto digitale nel repository.' } }
    ],
    loaded: true
  },
  'mimetypes': {
    terms: [
      ...
      { '@id': 'image/x-ms-bmp', 'skos:notation': ['x-ms-bmp'], 'skos:prefLabel': { 'eng': 'BMP (Microsoft Bitmap)' } },
      ...
      { '@id': 'video/vnd.avi', 'skos:notation': ['vnd.avi'], 'skos:prefLabel': { 'eng': 'AVI (vnd.avi)' } },
      { '@id': 'video/x-msvideo', 'skos:notation': ['x-msvideo'], 'skos:prefLabel': { 'eng': 'AVI (x-msvideo)' } },
  ...
  'objecttypeuwm': {
    terms: [
      ...
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556240', 'skos:prefLabel': { 'eng': 'Preprint', 'deu': 'Preprint', 'ita': 'Preprint' } },
  ...
  'objecttype': {
    terms: [
      ...
      { '@id': ns + 'T023-BGTD', 'skos:prefLabel': { 'eng': 'preprint', 'deu': 'Preprint', 'ita': 'Preprint' } },
  ...
  'audience': {
    terms: [
      { '@id': ns + 'TEPR-J4EZ', 'skos:prefLabel': { 'eng': 'FSK ab 0 freigegeben', 'ita': 'Approvato dagli 0 anni' } },
      { '@id': ns + '7ANY-9744', 'skos:prefLabel': { 'eng': 'FSK ab 6 freigegeben', 'ita': 'Approvato dai 6 anni' } },
      { '@id': ns + '4DQY-TNPT', 'skos:prefLabel': { 'eng': 'FSK ab 12 freigegeben', 'ita': 'Approvato dai 12 anni' } },
      { '@id': ns + 'HSDH-MD0J', 'skos:prefLabel': { 'eng': 'FSK ab 16 freigegeben', 'ita': 'Approvato dai 16 anni' } },
      { '@id': ns + 'F2VP-9Z07', 'skos:prefLabel': { 'eng': 'FSK ab 18 freigegeben', 'ita': 'Approvato dai 18 anni' } },
      { '@id': ns + 'C2TK-3DTQ', 'skos:prefLabel': { 'eng': 'Freigegeben gemäß §14 JuSchG FSK', 'ita': 'Approvato ai sensi del §14 della Legge tedesca sulla protezione dei minori (FSK)' } }
    ],
    loaded: true
  },
  'oeraudience': {
    terms: [
      { '@id': ns + '7RSE-DD9C', 'skos:prefLabel': { 'eng': 'Primary School', 'deu': 'Primarstufe', 'ita': 'Scuola primaria' } },
      { '@id': ns + 'KNB1-BJBV', 'skos:prefLabel': { 'eng': 'Primary School Level I', 'deu': 'Primarstufe GS I', 'ita': 'Scuola primaria  – livello I' } },
      { '@id': ns + 'PYJ6-HQ52', 'skos:prefLabel': { 'eng': 'Primary School Level II', 'deu': 'Primarstufe GS II', 'ita': 'Scuola primaria – livello II' } },
      { '@id': ns + 'N26X-38N8', 'skos:prefLabel': { 'eng': 'Secondary School', 'deu': 'Sekundarstufe', 'ita': 'Scuola secondaria' } },
      { '@id': ns + 'G6X5-JRMG', 'skos:prefLabel': { 'eng': 'Secondary School lower sec.', 'deu': 'Sekundarstufe Sek I', 'ita': 'Scuola secondaria di primo grado' } },
      { '@id': ns + 'NTNX-9GPN', 'skos:prefLabel': { 'eng': 'Secondary School higher sec.', 'deu': 'Sekundarstufe Sek II', 'ita': 'Scuola secondaria di secondo grado' } },
      { '@id': ns + '2W2J-XQNW', 'skos:prefLabel': { 'eng': 'Adult Education / Higher Education', 'deu': 'Erwachsenenbildung/Hochschule', 'ita': 'Educazione degli adulti / Istruzione superiore' } },
      { '@id': ns + 'CGD1-16CQ', 'skos:prefLabel': { 'eng': 'general educational resource', 'deu': 'Allgemeine Bildungsressource', 'ita': 'Risorsa educativa generale' } },
      { '@id': ns + 'GZWD-CGJ0', 'skos:prefLabel': { 'eng': 'miscellaneous educational resource', 'deu': 'Sonstige Bildungsressource', 'ita': 'Risorsa educativa varia' } }
    ],
    loaded: true
  },
  'regionalencoding': {
