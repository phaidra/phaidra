      ...
      <v-tab-item class="pa-8">
        <v-container>
          <v-row>
            ...
            <v-col cols="3" class="mt-4">{{ $t("Header component. (Enclose <template></template> in a <div></div>)") }}</v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-textarea
            ...
            <v-col cols="3" class="mt-4">{{ $t("Footer component. (Enclose <template></template> in a <div></div>)") }}</v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-textarea
            ...
            <v-col cols="3" class="mt-4">{{ $t("Homepage component. (Enclose <template></template> in a <div></div>)") }}</v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-textarea
            ...
            <v-col cols="3" class="mt-4">{{ $t("Impressum component. (Enclose <template></template> in a <div></div>)") }}</v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-textarea
            ...
            <v-col cols="3" class="mt-4">{{ $t("Submit langing page component. (Enclose <template></template> in a <div></div>)") }}</v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-textarea
