          ...
          <v-row justify="end">
            <v-col cols="12" md="9">
              <ul class="mb-6 pl-0 side-list">
                ...
                <li class="mb-6" v-if="(objectInfo.isrestricted) && (objectInfo.cmodel !== 'Collection' || objectInfo.cmodel !== 'Container')"><v-chip label dark color="btnred" class="pointer-disabled"><v-icon small left>mdi-lock</v-icon>{{ $t('Restricted access') }}</v-chip></li>
                <li class="mb-6" v-if="
